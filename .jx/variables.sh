...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-plugins/lighthouse-webui-plugin/main/3'
...
export MINK_IMAGE='ghcr.io/jenkins-x/lighthouse-webui-plugin:0.1.5'
