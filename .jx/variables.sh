...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-plugins/lighthouse-webui-plugin/HEAD/2'
...
export MINK_IMAGE='ghcr.io/jenkins-x/lighthouse-webui-plugin:0.1.4'
